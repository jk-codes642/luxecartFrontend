  ...
  return (
    <footer class="tracking-wide bg-gray-50 px-10 pt-12 pb-6">
      <div class="flex flex-wrap justify-between gap-10">
        <div class="max-w-md">
          <a href="javascript:void(0)">
            <p className="text-3xl">LuxeCart</p>
          </a>
          <div class="mt-6">
        ...
        <div class="max-lg:min-w-[140px]">
          <h4 class="text-slate-900 font-semibold text-sm">Shop</h4>
          <ul class="mt-6 space-y-4">
            <li>
              <a href="#" class="hover:text-slate-900 text-slate-600">
                New Arrivals
              </a>
            </li>
            <li>
        ...
        <div class="max-lg:min-w-[140px]">
          <h4 class="text-slate-900 font-semibold text-sm">Customer Service</h4>
          <ul class="mt-6 space-y-4">
            <li>
              <a href="#" class="hover:text-slate-900 text-slate-600">
                Help Center
        ...
        <div class="max-lg:min-w-[140px]">
          <h4 class="text-slate-900 font-semibold text-sm">Company</h4>
          <ul class="mt-6 space-y-4">
            <li>
              <a href="#" class="hover:text-slate-900 text-slate-600">
                About LuxeCart
        ...
        <div class="max-lg:min-w-[140px]">
          <h4 class="text-slate-900 font-semibold text-sm">Quick Access</h4>
          <ul class="mt-6 space-y-4">
            <li>
              <a href="#" class="hover:text-slate-900 text-slate-600">
                My Account
      ...
      <div class="flex flex-wrap max-md:flex-col gap-4">
        <ul class="md:flex md:space-x-6 max-md:space-y-2">
          <li>
            <a
              ...
              class="hover:text-slate-900 text-slate-600 text-sm font-normal"
            >
              Terms of Service
            </a>
          </li>
        ...
        <p class="text-slate-600 text-sm md:ml-auto">
          © LuxeCart. All rights reserved.
        </p>
      </div>
    </footer>
  );
